<template>
  <div class="min-h-screen bg-[#e0e5ec] text-gray-800">
    ...
    <header class="fixed top-0 left-0 right-0 z-50 bg-[#e0e5ec]">
      <div class="max-w-6xl mx-auto px-6 md:px-8 h-16 grid grid-cols-3 items-center">
        ...
        <div class="flex items-center justify-start">
          <RouterLink to="/" class="flex items-center gap-3">
            ...
            <span class="font-semibold text-base text-gray-800 hidden sm:inline">ResuMatch</span>
          </RouterLink>
        </div>
        ...
        <div class="flex items-center justify-end gap-1">
          ...
          <RouterLink to="/settings" title="设置"
            class="relative w-9 h-9 rounded-lg flex items-center justify-center text-gray-600 text-base
